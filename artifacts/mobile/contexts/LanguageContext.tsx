...
const translations = {
  en: {
    ...
    wallet_view_breakdown: 'View balance breakdown',
    wallet_hide_breakdown: 'Hide balance breakdown',
    wallet_breakdown_title: 'Balance breakdown',
    wallet_breakdown_deposit: 'Deposited funds',
    wallet_breakdown_bonus: 'Bonus funds',
    wallet_breakdown_winnings: 'Withdrawable winnings',
    wallet_breakdown_withdrawn: 'Already withdrawn',
    wallet_breakdown_pending: 'Pending withdrawal',
    wallet_breakdown_note: 'Deposit and bonus funds can be used to play. Only winnings can be withdrawn.',
    wallet_withdraw_unavailable_title: 'Withdrawal unavailable',
    wallet_withdraw_unavailable_msg: 'You can withdraw only winnings. Keep playing to earn withdrawable winnings.',
    ...
    wallet_upi_label: 'UPI Option %s',
     wallet_upi_account: 'UPI ID',
    wallet_copy_id: 'Copy ID',
    wallet_copied: 'Copied!',
    wallet_pay_now: 'Pay Now',
     wallet_pay_section_title: 'Pay via UPI',
     wallet_pay_section_subtitle: 'Choose the amount and pay using the UPI ID below.',
     wallet_payment_proof_title: 'Payment Proof',
     wallet_payment_proof_subtitle: 'After sending the money, submit your proof for verification.',
     wallet_upi_not_configured: 'UPI payment details are not available right now. Please contact support.',
    ...
    wallet_utr_label: 'Payment Reference Number (optional)',
    wallet_utr_placeholder: 'Enter payment reference number (optional)',
    ...
    wallet_after_payment_title: 'After Payment',
     wallet_after_payment_msg: 'Screenshot is required; payment reference number is optional.',
    wallet_ok: 'OK',
