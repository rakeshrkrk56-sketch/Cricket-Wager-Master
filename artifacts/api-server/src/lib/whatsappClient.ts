...
function createClient(): Client {
  ...
  nextClient.on("ready", () => logger.info("WhatsApp OTP client is ready"));
  nextClient.on("authenticated", () => logger.info("WhatsApp OTP client authenticated"));
  nextClient.on("auth_failure", (message) => logger.error({ message }, "WhatsApp OTP authentication failed"));
